...
Crucible.addRecipe("LEAFY", cinderpearl, amber, "herba 4, ignis 2, praecantatio 2");
Crucible.addRecipe("LEAFY", shimmerleaf, quicksilver, "herba 4, permutatio 2, praecantatio 2");
...
Research.addCruciblePage("LEAFY", cinderpearl);
Research.addCruciblePage("LEAFY", shimmerleaf);